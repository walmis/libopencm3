...
#define USB_SET_EP_RX_0_ADDR(EP, ADDR)    SET_REG(USB_EP_TX_ADDR(EP), ADDR)
#define USB_SET_EP_RX_0_COUNT(EP, COUNT)  SET_REG(USB_EP_TX_COUNT(EP), COUNT)
#define USB_SET_EP_RX_1_ADDR(EP, ADDR)    SET_REG(USB_EP_RX_ADDR(EP), ADDR)
#define USB_SET_EP_RX_1_COUNT(EP, COUNT)  SET_REG(USB_EP_RX_COUNT(EP), COUNT)
#define USB_SET_EP_TX_0_ADDR(EP, ADDR)    SET_REG(USB_EP_TX_ADDR(EP), ADDR)
#define USB_SET_EP_TX_0_COUNT(EP, COUNT)  SET_REG(USB_EP_TX_COUNT(EP), COUNT)
#define USB_SET_EP_TX_1_ADDR(EP, ADDR)    SET_REG(USB_EP_RX_ADDR(EP), ADDR)
#define USB_SET_EP_TX_1_COUNT(EP, COUNT)  SET_REG(USB_EP_RX_COUNT(EP), COUNT)
